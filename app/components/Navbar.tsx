...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      scrolled 
        ? 'bg-dark-900/95 backdrop-blur-lg border-b border-dark-700 data-[theme=light]:bg-white/95 data-[theme=light]:border-gray-200' 
        : 'bg-transparent'
    }`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center space-x-2 px-3 py-2 rounded-lg transition-all duration-300 group ${
                    isActive 
                      ? 'text-primary-400 bg-primary-400/10 data-[theme=light]:text-primary-600 data-[theme=light]:bg-primary-100' 
                      : 'text-gray-300 hover:text-primary-400 hover:bg-primary-400/5 data-[theme=light]:text-gray-600 data-[theme=light]:hover:text-primary-600 data-[theme=light]:hover:bg-primary-50'
                  }`}
                >
        ...
        <div className={`md:hidden transition-all duration-300 overflow-hidden ${
          ...
          <div className="py-4 space-y-2 bg-dark-900/95 backdrop-blur-lg border-t border-dark-700 data-[theme=light]:bg-white/95 data-[theme=light]:border-gray-200">
            {navItems.map((item) => {
              const Icon = item.icon
              const isActive = pathname === item.href
